    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Checkout(
          ...
          sizeLabel: '1 BHK',
          price: total,
          serviceTitle: "6 Month Cleaning Plan",
        ),
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text("6 Month Cleaning Plan",
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(height: 6),
          const Text("Bi-weekly cleaning service for half a year."),
          const SizedBox(height: 10),
          Row(
            children: [
              _buildBadge("AED 230/month", Icons.monetization_on),
              const SizedBox(width: 8),
              _buildBadge("Trusted professionals", Icons.verified, bgColor: Colors.orange.shade50),
            ],
          ),
          const SizedBox(height: 16),
          ClipRRect(
